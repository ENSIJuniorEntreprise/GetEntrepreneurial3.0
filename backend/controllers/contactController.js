...
exports.createContactMessage = async (req, res) => {
  try {
    ...
    const newMessage = await Contact.create({ prenom, nom, email, sujet, message });
    res.status(201).json({ success: true, message: 'Votre message a bien été envoyé.', data: newMessage });
  } catch (error) {
